    ...
    impl ColumnIter {
        fn get(&self, idx: usize) -> Option<Column> {
            match idx {
                ...
                4usize => ::core::option::Option::Some(Column::Submits),
    ...
    impl std::str::FromStr for Column {
        ...
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            match s {
                ...
                "submits" | "submits" => Ok(Column::Submits),
            ...
            Ok(Self {
                ...
                submits: row
                    .try_get(
                        pre,
                        sea_orm::IdenStatic::as_str(
                                &<<Self as sea_orm::ModelTrait>::Entity as sea_orm::entity::EntityTrait>::Column::Submits,
                            )
                            .into(),
                    )?,
                ac_rate: row
    ...
    impl sea_orm::ModelTrait for Model {
        ...
        fn get(
            ...
            match c {
                ...
                <Self::Entity as sea_orm::entity::EntityTrait>::Column::Submits => {
    ...
    impl sea_orm::ActiveModelTrait for ActiveModel {
        ...
        fn take(
            ...
            match c {
                ...
                <Self::Entity as EntityTrait>::Column::Submits => {
                    let mut value = sea_orm::ActiveValue::not_set();
        ...
        fn reset(&mut self, c: <Self::Entity as EntityTrait>::Column) {
            match c {
                ...
                <Self::Entity as EntityTrait>::Column::Submits => self.submits.reset(),
